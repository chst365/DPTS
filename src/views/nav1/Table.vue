<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="rank" label="意向等级" width="120"  sortable>
			</el-table-column>
			<el-table-column prop="empName" label="负责人" width="100" sortable>
			</el-table-column>
			<el-table-column prop="phone" label="学员手机" width="120" sortable>
			</el-table-column>
			<el-table-column prop="parentPhone" label="家长手机" width="120" sortable>
			</el-table-column>
			<el-table-column prop="createDate" label="创建时间" min-width="180" sortable>
			</el-table-column>
			<el-table-column prop="modifyDate" label="最近更新时间" min-width="180" sortable>
			</el-table-column>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="年级" prop="source">
